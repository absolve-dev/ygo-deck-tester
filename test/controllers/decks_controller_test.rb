...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { contents: @deck.contents, name: @deck.name, notes: @deck.notes, owner: @deck.owner }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { contents: @deck.contents, name: @deck.name, notes: @deck.notes, owner: @deck.owner }
    assert_redirected_to deck_path(assigns(:deck))
  end
